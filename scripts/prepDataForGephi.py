...
parser.add_argument('--input-files', dest= 'inputfiles', default = None, required = True, help='regular expression for input data file(s)')
parser.add_argument('--edgemap-output', dest='edgemapout', default = "", help='filepath for edge map output (csv)')
parser.add_argument('--nodemap-input', dest='nodemapin', default = None, help='filepath for node map input (csv)')
parser.add_argument('--nodemap-output', dest='nodemapout', default = "", help='filepath for node map output (csv)')
parser.add_argument('--maf-threshold', dest='mafthresh', help='threshold for minor allele frequency filtration')
parser.add_argument('--casecount-threshold', dest='ccthresh', help='threshold for case count filtration')
parser.add_argument('--pvalue-threshold', dest='pvalthresh', help='threshold for significance of association between SNP and phenotype')
parser.add_argument('--phenotype-name', dest='phenotypename', help='name of variable corresponding to phenotype ID')
parser.add_argument('--snp-name', dest='snpname', required=True, help='name of variable corresponding to SNP ID')
parser.add_argument('--maf-name', dest='mafname', help='name of variable corresponding to minor allele frequency')
parser.add_argument('--casecount-name', dest='ccname', help='name of variable corresponding to case count')
parser.add_argument('--pvalue-name', dest='pvname', help='name of variable corresponding to p-value of association')
parser.add_argument('--delim', dest='delim', required=True, help='delimiter used in input PheWAS data')
parser.add_argument('--ld-file', dest='ldfile', help='linkage disequilibrium file generated using plink --show-tags. Custom file will also work as long as the header has "SNP" and "TAGS"')
